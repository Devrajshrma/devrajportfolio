var projects = [
    {value : "PROJECT 2", name :"Netflix Clone", img :"./img/2.png", a:"https://devrajshrma.github.io/nxui/", button:"<button>HTML</button><button>CSS</button><button>MediaQuery</button>"},
    {value : "PROJECT 1", name :"Great Jones Clone", img :"./img/1.png", a:"https://devgreatjones.netlify.app/", button:"<button>HTML</button><button>CSS</button><button>MediaQuery</button><button>JS</button>"},
    {value : "PROJECT 3", name :"Amazone Clone", img :"./img/3.png", a:"https://devzon.netlify.app/", button:"<button>HTML</button><button>CSS</button><button>MediaQuery</button><button>JS</button>"},
