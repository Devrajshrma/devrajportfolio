var projects = [
    ...
    {value : "PROJECT 1", name :"Great Jones Clone", img :"./img/1.png", a:"https://devgreatjones.netlify.app/", button:"<button>HTML</button><button>CSS</button><button>MediaQuery</button>"},
